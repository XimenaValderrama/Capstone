 ...
 * @author digim
 */
public class Tenencia_Responsable extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public Tenencia_Responsable() {
        setResizable(false);
        initComponents();
    ...
    private void initComponents() {
        ...
        BTEliminarPA.setText("Eliminar Tenencia Responsable");
        ...
        BTModificarPA.setText("Modificar Tenencia Responsable");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tenencia_Responsable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tenencia_Responsable().setVisible(true);
            }
        });
    }
